...
showQuote() {
    return (
            <div class = "mt-5">
                ...
                <button type="button" className="btn btn-black" onClick={this.changeEdit} value={this.state.index}>Edit</button>
                <button type="button" className="btn btn-danger" onClick={this.changeDelete} value={this.state.index}>Delete</button>
            </li>
            </div>
            )
}
